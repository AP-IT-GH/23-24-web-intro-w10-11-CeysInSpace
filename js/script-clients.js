    ...
    for (let i = 0; i < response.results.length; i++) {
      ...
      html += `<div class="card col-12 col-sm-6 col-md-4">
        ...
        user.name.first
			...
			<div class="card-body">
			<p class="card-title text-uppercase fs-6 fw-bolder pt-3"> ${user.name.first} ${
        user.name.last
      }        </p>
			<p class="card-text h6 small mt-2">Ik kom uit  en ben fan van de koffiebonen van ${random_item(
        brands
      )}!</p>
